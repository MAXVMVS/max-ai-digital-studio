      ...
      <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-8 items-center relative z-10">
        ...
        <div className="lg:col-span-7 flex flex-col justify-center text-left">
          ...
          >
            <a
              href="#onboarding"
              className="px-8 py-4.5 rounded-full bg-[#C17F4E] text-[#F8FAFC] font-semibold text-center tracking-wider uppercase text-xs shadow-[0_4px_24px_rgba(193,127,78,0.25)] hover:bg-[#D79663] transition-all duration-300 flex items-center justify-center gap-2 group"
            >
              Iniciar Onboarding
