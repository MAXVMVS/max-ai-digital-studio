...
export const TRANSLATIONS = {
  es: {
    ...
    heroTitle3: 'crecer.',
    heroTitle4: '',
    heroSub: 'Desarrollo Web, Marketing Digital, Automatización & Ecosistemas IA a tu medida.',
  ...
  en: {
    ...
    heroTitle3: 'grow.',
    heroTitle4: '',
    heroSub: 'Web Development, Digital Marketing, Automation & AI Ecosystems tailored to your needs.',
